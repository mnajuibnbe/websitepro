  ...
  return (
    <div className="min-h-screen bg-primary-50 flex flex-col">
      ...
      <header className="h-16 bg-white border-b border-primary-200 px-4 sm:px-6 flex items-center justify-between sticky top-0 z-30">
        <a href="#/lesson" className="flex items-center gap-2 text-primary-600 hover:text-accent-600 transition-colors group min-h-[44px]">
        ...
        <button onClick={() => window.location.hash = '#/lesson'} className="min-w-[44px] min-h-[44px] flex items-center justify-center rounded-full hover:bg-primary-50 text-primary-500 hover:text-primary-900 transition-colors">
          <X className="w-5 h-5" />
        </button>
      </header>
