        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-3xl shadow-sm border border-primary-200 p-8 md:p-10">
            <div className="flex items-center gap-6 mb-10 pb-8 border-b border-primary-100">
              ...
              <div>
                <h1 className="text-3xl font-bold text-primary-900 mb-2">{user?.name || 'مستخدم'}</h1>
            ...
            <div className="space-y-8">
              <section>
                ...
                <div className="bg-primary-50 p-6 rounded-2xl border border-primary-100">
                  <p className="text-primary-700 mb-4">يمكنك تغيير كلمة المرور الخاصة بك من هنا.</p>
                  <Button variant="secondary" className="bg-white">تغيير كلمة المرور</Button>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="bg-primary-50 p-6 rounded-2xl border border-primary-100 space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="text-primary-700 font-medium">استلام تنبيهات الكورسات الجديدة</span>
                    <input type="checkbox" className="w-5 h-5 accent-accent-600" defaultChecked />
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-primary-700 font-medium">إشعارات التقدم في الدروس</span>
                    <input type="checkbox" className="w-5 h-5 accent-accent-600" defaultChecked />
                  </div>
                </div>
              </section>
            ...
            <div className="mt-10 flex justify-end">
              <Button variant="primary" className="px-8">حفظ التغييرات</Button>
            </div>
          </div>
        </div>
      </main>
