...
export function BlogPost() {
  ...
  useEffect(() => {
    const url = deriveCanonicalUrl(window.location.origin, slug);
    ...
    const title = post.seo_title?.trim() || deriveSeoTitle(post.title);
    const description = post.meta_description?.trim() || deriveMetaDescription(post.excerpt, post.content);
