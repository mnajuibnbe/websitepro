          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-2xl border border-primary-200 p-6 md:p-8 shadow-sm">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-bold text-primary-900">Content</h2>
                ...
                {lessons.map((lesson, index) => (
                  <div key={lesson.id} className="p-4 border border-primary-200 rounded-xl bg-primary-50 relative group">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-xs font-bold text-primary-700 mb-1">Lesson {index + 1}</label>
                        <input type="text" className="w-full px-3 py-2 bg-white border border-primary-200 rounded-lg focus:ring-2 focus:ring-accent-500 text-sm" placeholder="Lesson" />
                      </div>
                      <div>
                        <label className="block text-xs font-bold text-primary-700 mb-1">Link (URL)</label>
