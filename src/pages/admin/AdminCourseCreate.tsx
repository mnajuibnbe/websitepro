    ...
    try {
      ...
      if (rpcError) {
        ...
        if (rpcError.message?.includes('duplicate key') || rpcError.message?.includes('courses_slug_key')) {
          errorMsg = 'This course URL slug is already in use. Please choose another.';
      ...
      if (!rpcCourseId) {
        addToast('error', 'Unable to create the course. Please try again.');
        setIsSubmitting(false);
        return;
      }
      ...
      addToast('error', err.message || 'Unable to create the course. Please try again.');
      setIsSubmitting(false);
    }
  };
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-primary-600 text-xs sm:text-sm">
                  Enter the basic course information, then continue to the curriculum builder.
                </p>
              </div>
            </div>
