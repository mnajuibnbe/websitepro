...
export function UnauthorizedPage() {
  ...
  return (
    <div className="min-h-screen bg-primary-50 flex flex-col items-center justify-center p-4" dir="rtl">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-sm border border-primary-100 p-8 text-center">
        ...
        <h1 className="text-3xl font-bold text-primary-900 mb-4">عفواً، وصول مرفوض</h1>
        <p className="text-primary-600 mb-8 leading-relaxed">
          لا تملك الصلاحيات الكافية للوصول إلى هذه الصفحة. يرجى التحقق من حسابك أو العودة إلى لوحة التحكم.
        </p>
