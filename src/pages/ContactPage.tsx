          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-start">
            ...
            <div>
              ...
              <p className="text-lg text-primary-600 mb-12 max-w-lg leading-relaxed">
                Have a question about your account, payment, or a course? Our support team is ready to help.
              </p>
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-primary-600 mb-2">For account and course support</p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-primary-600 mb-2">Available Monday–Friday, 9:00 AM–5:00 PM</p>
            ...
            <div className="bg-white rounded-3xl shadow-sm border border-primary-200 p-8 md:p-10">
              ...
              {isSuccess ? (
                <div className="bg-success-50 text-success-700 p-6 rounded-xl border border-success-200 text-center animate-in fade-in duration-300">
                  ...
                  <p>Thank you for contacting us. Our support team will respond as soon as possible.</p>
                </div>
              ) : (
