    ...
    async function resolveContinueLearning() {
      ...
      try {
        ...
        if (enrollmentError) {
          ...
          setErrorMessage('This course could not be loaded. Please return to My Courses and try again.');
          setState('error');
          return;
        }
    ...
    return (
      <div className="min-h-screen bg-primary-50 flex flex-col items-center justify-center p-4 text-left" dir="ltr">
        <div className="bg-white p-8 rounded-2xl border border-primary-200 shadow-md text-center max-w-md w-full">
          ...
          <h2 className="text-2xl font-bold text-primary-900 mb-2">Course Unavailable</h2>
          <p className="text-primary-600 mb-6 leading-relaxed">
            This course could not be loaded. Please return to My Courses and try again.
          </p>
          <button
  ...
  return (
    <div className="min-h-screen bg-primary-50 flex flex-col items-center justify-center p-4 text-left" dir="ltr">
      <div className="bg-danger-50 text-danger-700 p-8 rounded-2xl border border-danger-200 text-center max-w-md w-full">
        ...
        <p className="mb-6">{errorMessage || 'Unable to open this course.'}</p>
        <button
          onClick={() => navigate('/my-courses')}
