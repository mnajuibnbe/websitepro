      ...
      <div className="flex-grow flex flex-col min-h-screen overflow-hidden">
        ...
        <header className="h-20 bg-white border-b border-primary-200 px-4 sm:px-8 flex items-center justify-between sticky top-0 z-30">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl md:text-2xl font-bold text-primary-900 hidden sm:block">مرحباً بعودتك! 👋</h1>
          </div>
        ...
        <main className="flex-grow p-4 sm:p-8 overflow-y-auto">
          <div className="max-w-6xl mx-auto space-y-8 pb-12">
            ...
            {/* Mobile Greeting */}
            <h1 className="text-2xl font-bold text-primary-900 sm:hidden mb-6">مرحباً بعودتك! 👋</h1>
            ...
            {isLoading ? (
               ...
               <div className="bg-white rounded-2xl border border-primary-200 shadow-sm p-12 flex flex-col items-center justify-center text-center">
                 ...
                 <h2 className="text-2xl font-bold text-primary-900 mb-3">لم تقم بالاشتراك في أي دبلومة حتى الآن</h2>
                 <p className="text-primary-600 mb-8 max-w-md">
                   اكتشف مجموعة من أفضل الدبلومات والكورسات في مجال العناية بالبشرة والشعر وابدأ رحلة تعلمك الآن.
                 </p>
                 <Button 
                   variant="primary" 
