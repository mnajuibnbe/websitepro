...
export function CertificatePage() {
  ...
  const [studentName, setStudentName] = useState('د. سارة أحمد');
          ...
          {step === 'issued' && (
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 motion-reduce:animate-none motion-reduce:transform-none">
              <div className="text-center mb-10">
                <h1 className="text-3xl md:text-4xl font-bold text-primary-900 mb-4">شهادتك جاهزة!</h1>
                <p className="text-lg text-primary-600">تهانينا على إتمام الدبلومة. يمكنك الآن تحميل الشهادة أو مشاركتها.</p>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div className="lg:col-span-8">
                  <CertificatePreview 
                    ...
                    courseName="دبلومة العناية بالبشرة والشعر"
                    completionDate="23 يوليو 2026"
                    certificateId="TUT-2026-98765"
                    instructorName="د. آية البراشي"
                  />
                </div>

                {/* Actions - 4 Cols */}
                <div className="lg:col-span-4 bg-white border border-primary-200 rounded-2xl p-6 md:p-8 shadow-sm">
                  <h3 className="text-xl font-bold text-primary-900 mb-6">إجراءات الشهادة</h3>
                  ...
                  <div className="pt-6 border-t border-primary-100">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-bold text-primary-900 text-sm mb-1">شهادة معتمدة يمكن التحقق منها</h4>
                        <p className="text-xs text-primary-500 leading-relaxed">
                          يمكن لأي جهة التحقق من صحة هذه الشهادة باستخدام رقم المعرف (ID) أو عبر مسح رمز الاستجابة السريعة (QR Code).
                        </p>
                      </div>
                    </div>
                  </div>
