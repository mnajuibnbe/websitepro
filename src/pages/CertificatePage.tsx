...
export function CertificatePage() {
  ...
  return (
    <div className="min-h-screen bg-primary-50">
      <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-primary-200 bg-white px-4 sm:px-6"><Link to="/my-courses" className="flex min-h-11 items-center gap-2 font-semibold text-primary-600 hover:text-accent-700"><ArrowLeft className="h-5 w-5" aria-hidden="true" />My Courses</Link><span className="font-bold text-primary-900">Certificates</span><span className="w-10" /></header>
      <main id="main-content" className="mx-auto max-w-6xl px-4 py-12 sm:px-8">
