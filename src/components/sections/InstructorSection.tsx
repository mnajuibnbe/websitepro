      ...
      <PageContainer>
        <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-12">
          ...
          <Reveal className="relative order-2 lg:order-1 lg:col-span-5">
            <div className="aspect-square overflow-hidden rounded-[2.5rem] border border-primary-200 bg-gradient-to-br from-white via-warning-50 to-accent-50 p-6 shadow-xl shadow-primary-900/5 sm:p-10">
          ...
          <div className="order-1 flex flex-col items-center text-center lg:order-2 lg:col-span-7 lg:items-start lg:text-left">
            <Reveal>
              ...
              <p className="mx-auto mb-8 max-w-2xl text-lg leading-relaxed text-primary-600 lg:mx-0">
