...
export function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-primary-50 pb-section-lg pt-32 md:pb-section-xl md:pt-40">
      <div
        aria-hidden="true"
        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-8">
          ...
          <Reveal delay={0.15} className="relative lg:col-span-6">
            <div className="relative rounded-frame bg-gradient-to-br from-accent-300/50 via-accent-100/30 to-transparent p-0.5 shadow-[0_30px_70px_-25px_rgba(13,148,136,0.45)]">
              <div className="relative aspect-[4/5] w-full overflow-hidden rounded-[calc(var(--radius-frame)-2px)] border border-primary-800 bg-primary-900 sm:aspect-[4/3] lg:aspect-square">
                {isPlayingIntro ? (
                  <>
                  ...
                  <>
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center px-6 py-8 text-center text-white sm:px-8">
                      ...
                      <button
                        ...
                        className="mt-8 flex h-16 w-16 cursor-pointer items-center justify-center rounded-full bg-white text-accent-700 shadow-2xl transition-[transform,background-color] duration-200 ease-out hover:scale-105 hover:bg-accent-50 active:scale-95 focus:outline-none focus:ring-4 focus:ring-accent-300/50 sm:h-20 sm:w-20"
                      >
