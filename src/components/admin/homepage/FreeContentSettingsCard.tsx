  ...
  return (
    <form onSubmit={save} className="rounded-2xl border border-primary-200 bg-white p-6 shadow-sm md:p-8">
      <div className="mb-6 flex items-center gap-3 border-b border-primary-100 pb-5">
        ...
        <div><h2 className="font-bold text-primary-900">Free content section (currently hidden)</h2><p className="text-sm text-primary-500">The "Free Learning Resources" cards. Hidden from the homepage by default — replaced by the real-data "Course Preview Lessons" section below Courses. Turn it back on in Homepage layout above if you want it live again. Links must point somewhere on this site (start with /).</p></div>
      </div>
