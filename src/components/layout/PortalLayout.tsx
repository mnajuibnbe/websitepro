...
export function PortalLayout({ sidebar, children, maxWidth = 'max-w-6xl' }: PortalLayoutProps) {
  return (
    <div className="min-h-screen bg-primary-50 font-sans">
      {sidebar}
      <main id="main-content" className="pb-24 pt-8 transition-all duration-300 lg:pl-72">
