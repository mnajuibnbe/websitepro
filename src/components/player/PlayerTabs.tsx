  ...
  return (
    <div className="bg-white border border-primary-200 rounded-2xl shadow-sm overflow-hidden mb-12">
      ...
      <div className="p-6 md:p-8">
        ...
        {activeTab === 'resources' && (
          <div>
            <h3 className="text-xl font-bold text-primary-900 mb-6">Learn More</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="flex items-center justify-between p-4 rounded-xl border border-primary-200 hover:border-accent-500 hover:bg-accent-50 transition-colors group cursor-pointer">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-bold text-primary-900 text-sm">Learn More</h4>
        ...
        {activeTab === 'discussion' && (
          <div>
            <div className="flex items-center justify-between mb-6">
              ...
              <Button variant="secondary" className="text-sm px-4">Learn More</Button>
            </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    <h4 className="font-bold text-primary-900">Learn More</h4>
                    <span className="text-xs text-primary-400">Learn More</span>
                  </div>
                  ...
                  <div className="flex gap-4 mt-3 bg-primary-50 p-4 rounded-xl">
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-1">
                        <h4 className="font-bold text-primary-900">Learn More. Learn More <span className="text-xs bg-accent-100 text-accent-700 px-2 py-0.5 rounded-full ml-2">Instructor</span></h4>
                        <span className="text-xs text-primary-400">Learn More</span>
                      </div>
