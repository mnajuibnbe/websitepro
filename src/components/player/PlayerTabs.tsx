              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <div className="flex gap-4 mt-3 bg-primary-50 p-4 rounded-xl">
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-1">
                        <h4 className="font-bold text-primary-900">Course Content. Course Content <span className="text-xs bg-accent-100 text-accent-700 px-2 py-0.5 rounded-full ml-2">Instructor</span></h4>
                        <span className="text-xs text-primary-400">Course Content</span>
                      </div>
                      <p className="text-primary-700 text-sm leading-relaxed">
                        Confirm! Course Content.
                      </p>
                    </div>
                  </div>
                </div>
