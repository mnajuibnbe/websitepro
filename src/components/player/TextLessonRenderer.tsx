  ...
  if (!content || !content.trim()) {
    return (
      <div className="bg-white border border-primary-200 rounded-2xl p-8 md:p-12 text-center text-primary-600 shadow-sm">
        ...
        <h3 className="text-xl font-bold text-primary-900 mb-2">لا يوجد محتوى نصي للدرس</h3>
        <p className="text-primary-500 max-w-md mx-auto text-sm leading-relaxed">
          لم يتم إضافة محتوى تفصيلي لهذا الدرس النصي بعد. يرجى مراجعة ملخص الدرس أو الانتقال للدرس التالي.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="bg-white border border-primary-200 rounded-2xl p-6 md:p-10 shadow-sm text-right" dir="rtl">
      <div className="flex items-center gap-3 pb-4 mb-6 border-b border-primary-100 text-accent-700">
        ...
        <span className="font-bold text-sm">محتوى الدرس القتائي/النصي</span>
      </div>
