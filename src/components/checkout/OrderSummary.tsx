    ...
    <div className="bg-white border border-primary-200 rounded-2xl shadow-lg overflow-hidden lg:sticky lg:top-28">
      <div className="p-6 md:p-8">
        ...
        <div className="flex gap-4 mb-6 pb-6 border-b border-primary-100">
          ...
          />
          <div>
            <h3 className="font-bold text-primary-900 leading-snug mb-1">دبلومة العناية بالبشرة والشعر</h3>
            <p className="text-sm text-primary-500">الجزء الأول</p>
          </div>
        </div>
        ...
        {/* Coupon */}
        <div className="mb-8">
          <label className="block text-sm font-bold text-primary-700 mb-2">كود الخصم</label>
          <div className="flex gap-2">
            <div className="relative flex-grow">
              <Input type="text" placeholder="أدخل الكود هنا" className="w-full pl-10 text-left" dir="ltr" />
              <Tag className="w-4 h-4 absolute left-3 top-1/2 -translate-y-1/2 text-primary-400" />
            </div>
            <Button variant="secondary" className="px-6 text-sm">تطبيق</Button>
          </div>
        </div>
        ...
        <div className="flex items-center justify-center gap-2 text-xs text-primary-500 font-medium mt-6 text-center">
          ...
          <span>دفع آمن ومحمي بشهادة SSL. سياسة استرجاع مضمونة.</span>
        </div>
      </div>
    </div>
  );
