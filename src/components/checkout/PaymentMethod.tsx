    ...
    <div className="bg-white border border-primary-200 rounded-2xl p-6 md:p-8 shadow-sm mb-8">
      ...
      <div className="grid grid-cols-3 gap-3 md:gap-4 mb-8">
        ...
        >
          ...
          <span className="text-sm font-bold">Mobile Wallet</span>
        </button>
      </div>
      ...
      {method === 'card' && (
        <div className="space-y-6">
          <div>
            <label className="block text-sm font-bold text-primary-700 mb-2">Card Number</label>
          ...
          <div className="grid grid-cols-2 gap-4 md:gap-6">
            <div>
              <label className="block text-sm font-bold text-primary-700 mb-2">Expiration Date</label>
              <Input type="text" placeholder="MM/YY" className="w-full text-left" dir="ltr" />
            </div>
            <div>
              <label className="block text-sm font-bold text-primary-700 mb-2">Security Code (CVC)</label>
              <Input type="text" placeholder="123" className="w-full text-left" dir="ltr" />
            </div>
          </div>
          <div>
            <label className="block text-sm font-bold text-primary-700 mb-2">Name on Card</label>
      ...
      {method === 'paypal' && (
        <div className="text-center py-8">
          <p className="text-primary-600 font-medium mb-4">You will be redirected to PayPal to complete your payment.</p>
        </div>
      )}

      {method === 'local' && (
        <div className="text-center py-8">
          <p className="text-primary-600 font-medium mb-4">Enter the mobile number linked to your wallet.</p>
          <Input type="text" placeholder="Enter mobile number" className="w-full max-w-sm mx-auto text-center" dir="ltr" />
        </div>
      )}
    </div>
  );
