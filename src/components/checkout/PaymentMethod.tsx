    ...
    <div className="bg-white border border-primary-200 rounded-2xl p-6 md:p-8 shadow-sm mb-8">
      ...
      {method === 'card' && (
        <div className="space-y-6">
          <div>
            <label className="block text-sm font-bold text-primary-700 mb-2">Learn More</label>
          ...
          <div className="grid grid-cols-2 gap-4 md:gap-6">
            ...
            <div>
              <label className="block text-sm font-bold text-primary-700 mb-2">Learn More (CVC)</label>
      ...
      {method === 'paypal' && (
        <div className="text-center py-8">
          <p className="text-primary-600 font-medium mb-4">Learn More PayPal Payment.</p>
        </div>
      )}
      ...
      {method === 'local' && (
        <div className="text-center py-8">
          ...
          <Input type="text" placeholder="Learn More" className="w-full max-w-sm mx-auto text-center" dir="ltr" />
        </div>
      )}
    </div>
  );
