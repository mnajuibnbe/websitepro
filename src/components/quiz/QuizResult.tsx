  ...
  return (
    <div className="max-w-2xl mx-auto bg-white border border-primary-200 rounded-2xl p-8 md:p-12 shadow-sm text-center">
      ...
      <p className="text-lg text-primary-600 mb-8 leading-relaxed">
        You answered <strong className="text-primary-900">{score}</strong> out of <strong className="text-primary-900">{totalQuestions}</strong> questions correctly.
        {isPassed
          ? ' You can now continue to the next course section.'
          : ' Review the lesson material before trying again.'}
      </p>
