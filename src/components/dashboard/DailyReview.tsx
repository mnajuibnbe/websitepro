...
export function DailyReview() {
  const tasks = [
    { id: 1, title: 'مراجعة ملاحظات درس المرطبات', completed: true },
    { id: 2, title: 'اختبار القسم الثاني', completed: false },
    { id: 3, title: 'تمرين عملي: تحليل كريم (أجباري)', completed: false },
  ];

  return (
    <div className="bg-white border border-primary-200 rounded-2xl p-6 shadow-sm">
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-lg font-bold text-primary-900">المهام والمراجعة</h3>
