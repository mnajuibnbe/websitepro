...
export function LearningOutcomes({ outcomes }: { outcomes: string[] }) {
  ...
  return (
    <div className="mb-12 md:mb-16">
      ...
      {visibleOutcomes.length === 0 ? <div className="rounded-xl border border-dashed border-accent-200 bg-accent-50 p-6 text-primary-600">Learning outcomes have not been published for this course yet.</div> : <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
