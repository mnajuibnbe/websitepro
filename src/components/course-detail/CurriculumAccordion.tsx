...
export function CurriculumAccordion({ sections }: { sections: PublicCurriculumSection[] }) {
  ...
  return <section className="mb-12 md:mb-16" aria-labelledby="curriculum-heading">
    ...
    {previewLesson && <div className="fixed inset-0 z-[100] flex items-end justify-center bg-primary-900/85 backdrop-blur-sm sm:items-center sm:p-4" onMouseDown={event => event.target === event.currentTarget && setPreviewLesson(null)}>
