...
export function WhoIsThisFor({ audiences }: { audiences: string[] }) {
  ...
  return (
    <div className="mb-12 md:mb-16">
      ...
      {visibleAudiences.length === 0 ? <div className="rounded-xl border border-dashed border-primary-300 bg-primary-50 p-6 text-primary-600">Target audience details have not been published for this course yet.</div> : <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
