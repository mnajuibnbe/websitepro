      ...
      <div className="bg-white border border-primary-200 p-6 md:p-8 rounded-2xl shadow-sm">
        <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-center md:items-start text-center md:text-right">
          ...
          <div className="flex-grow">
            <h3 className="text-2xl font-bold text-primary-900 mb-2">Learn More. Learn More</h3>
            <p className="text-accent-600 font-bold mb-4">Learn More</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6 text-left">
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <span className="font-bold text-primary-900">Learn More 10 Learn More</span>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <span className="font-bold text-primary-900">8 Learn More</span>
                  <span className="text-xs text-primary-500 font-medium">Learn More</span>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <span className="font-bold text-primary-900">1000+ Learn More</span>
                  <span className="text-xs text-primary-500 font-medium">Learn More</span>
                </div>
              </div>
            </div>
