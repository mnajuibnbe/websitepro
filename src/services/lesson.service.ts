...
export class LessonService {
  ...
  static async createLesson(lessonData: Partial<Lesson>): Promise<Lesson> {
    const payload: Record<string, any> = {
      ...
      duration: typeof lessonData.duration === 'string' ? lessonData.duration.trim() || null : typeof lessonData.duration === 'number' ? String(lessonData.duration) : null,
  ...
  /**
   * Duplicate a lesson with " (Learn More)" appended to title and placed directly after the source lesson.
   */
