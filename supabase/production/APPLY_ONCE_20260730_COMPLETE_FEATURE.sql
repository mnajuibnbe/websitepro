...
-- Apply this file ONCE in the Supabase SQL editor. The rollout is all-or-nothing.
...
DO $$ BEGIN
 ...
 IF NOT EXISTS(SELECT 1 FROM public.platform_feature_releases WHERE release_key='course-review-production-v1') THEN RAISE EXCEPTION 'Feature rollout incomplete: release evidence is missing'; END IF;
END $$;
COMMIT;
